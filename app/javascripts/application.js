...
jQuery(document).ready(function() {
	...
	// image loader
		...
		if(jQuery(".reports_img_holder").length){var $gallery=true; var $load='a.load_reports_img'; var $delay_time=500; var $hover_class='reports_img_holder';}
		if(jQuery(".portfolio_full_img_holder").length){var $gallery_full=true; var $load='a.load_reports_img'; var $delay_time=500; var $hover_class='portfolio_full_img_holder';}
		...
		if($gallery) {
			jQuery(".loading_reports").each(function(index) {
				jQuery(this).addClass('img_pre_'+index);
			});
		}
		
		if($gallery_full) {
			jQuery(".loading_reports_full").each(function(index) {
				jQuery(this).addClass('img_pre_'+index);
			});
		}
		
		if($single_pic) {
			jQuery(".loading_reports_post").each(function(index) {
				jQuery(this).addClass('img_pre_'+index);
			});
		}
